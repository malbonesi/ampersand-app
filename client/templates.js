(function (root, factory) {
    ...
    templatizer["main"] = function tmpl_main() {
        return '<body><nav class="navbar navbar-inverse container-fluid"><a href="/" class="navbar-brand">Exuberant</a><ul class="nav navbar-nav navbar-right"><li> <a href="/login">Login</a></li><li><a href="/logout">Logout</a></li><li> <a href="/signup">Signup</a></li></ul></nav><main data-hook="page-container"></main></body>';
    };

    // pages/home.jade compiled template
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return "<section><h1>Home Page</h1></section>";
    };

    // pages/login.jade compiled template
    templatizer["pages"]["login"] = function tmpl_pages_login() {
        return '<section><h1>Log In</h1><form data-hook="login-form"><div data-hook="error-msg" class="error-text"></div><fieldset data-hook="field-container"></fieldset><button type="submit" class="btn btn-primary">Log In</button></form></section>';
    };

    // pages/signup.jade compiled template
    templatizer["pages"]["signup"] = function tmpl_pages_signup() {
        return '<section><h1>Sign Up</h1><form data-hook="signup-form"><div data-hook="error-msg" class="error-text"></div><fieldset data-hook="field-container"></fieldset><button type="submit" class="btn btn-primary">Sign Up</button></form></section>';
    };
